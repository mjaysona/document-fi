...
import Media from './src/collections/Media/index.ts'
import { s3Storage } from '@payloadcms/storage-s3'
import Posts from './src/collections/Posts/index.ts'
import Pages from './src/collections/Pages/index.ts'
import { nestedDocsPlugin } from '@payloadcms/plugin-nested-docs'
import UserRoles from './src/collections/UserRoles/index.ts'
import { initialData } from './src/seed/db.ts'
import Sessions from './src/collections/Sessions/index.ts'
import Accounts from './src/collections/Accounts/index.ts'
import UserPreferences from './src/collections/UserPreferences/index.ts'
import DashboardCustomization from './src/collections/DashboardCustomization/index.ts'
import WeightBills from './src/collections/WeightBills/index.ts'
import WeightBillReceipts from './src/collections/WeightBillReceipts/index.ts'
import SessionUploads from './src/collections/SessionUploads/index.ts'
import Vehicles from './src/collections/Vehicles/index.ts'
import APIConnections from './src/collections/APIConnections/index.ts'
import Equipment from './src/collections/Equipment/index.ts'
import EquipmentMedia from './src/collections/EquipmentMedia/index.ts'
import Quotes from './src/collections/Quotes/index.ts'
